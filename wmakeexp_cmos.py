...
print('MOS_lists-----------------------------------------')
if CONFIG_CMOS_A_PATH.exists() or \
    CONFIG_CMOS_B_PATH.exists() or \
    CONFIG_CMOS_C_PATH.exists():
    print(f'Make {CONFIG_CMOS_A_PATH}')
    print(f'Make {CONFIG_CMOS_B_PATH}')
    print(f'Make {CONFIG_CMOS_C_PATH}')
...
a_list = a.name.values.tolist()
b_list = b.name.values.tolist()
c_list = c.name.values.tolist()
...
df_a.to_csv(CONFIG_CMOS_A_PATH, index=False)
df_b.to_csv(CONFIG_CMOS_B_PATH, index=False)
df_c.to_csv(CONFIG_CMOS_C_PATH, index=False)
print('fin')
